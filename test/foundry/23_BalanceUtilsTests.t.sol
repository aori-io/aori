...
contract BalanceWrapper {
    ...
    function validateBalanceTransfer(
        ...
        return balance.validateBalanceTransfer(
            initialOffererLocked, finalOffererLocked, initialSolverUnlocked, finalSolverUnlocked, transferAmount
        );
    }
...
contract BalanceUtilsTest is Test {
    ...
    function test_validateBalanceTransferOrRevert_edgeCases() public {
        ...
        wrapper.validateBalanceTransferOrRevert(100, 100, 50, 50, 0);

        // Test with maximum values
        wrapper.validateBalanceTransferOrRevert(MAX_UINT128, MAX_UINT128 - 1, 0, 1, 1);
    }
