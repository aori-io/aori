...
contract WithdrawTests is TestUtils {
    ...
    function testWithdrawPartialBalance_ValidAmount() public {
        ...
        assertEq(outputToken.balanceOf(solver), initialTokenBalance + PARTIAL_AMOUNT, "Solver should receive the partial amount");
    }
    ...
    function testWithdrawStateConsistency_AfterFailure() public {
        ...
        assertEq(outputToken.balanceOf(solver), initialTokenBalance, "Token balance should be unchanged after failed withdrawal");
    }
