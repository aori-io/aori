...
contract SC_NativeHookAtomicSwap_Test is TestUtils {
    ...
    function testSingleChainNativeWithHookSuccess() public {
        ...
        assertEq(userSC.balance, initialUserNative - INPUT_AMOUNT, "User should spend native ETH");
    ...
    function testSingleChainNativeHookMechanics() public {
        ...
        assertEq(address(mockHook2).balance, hookInitialNative + INPUT_AMOUNT, "Hook should receive native ETH");
        assertEq(outputToken.balanceOf(address(mockHook2)), hookInitialTokens - HOOK_OUTPUT, "Hook should send output tokens");
    }
    ...
    function testSingleChainNativeWithHookFullFlow() public {
        ...
        console.log(
            "Flow: User deposits 1 ETH -> SrcHook converts to 1100 tokens -> User gets 1000 tokens, solver gets 100 tokens -> Atomic settlement"
        );
        console.log("");
