...
contract CC_ERC20ToNativeHook is TestUtils {
    ...
    function setUp() public override {
        ...
        vm.mockCall(address(dstHookPreferredToken), abi.encodeWithSelector(dstHookPreferredToken.decimals.selector), abi.encode(uint8(6)));
    ...
    function testPhase1_DepositERC20WithSrcHook() public {
        ...
        assertEq(inputToken.balanceOf(userSource), initialUserInputTokens - INPUT_AMOUNT, "User should have spent input tokens");
    ...
    function testPhase2_FillWithDstHook() public {
        ...
        assertEq(userDest.balance, preFillUserNative + OUTPUT_AMOUNT, "User should receive exact native output amount");
    ...
    function testCrossChainERC20ToNativeHookSuccess() public {
        ...
        console.log(
            "Flow: User deposits 1000 ERC20 -> srcHook (1000 ERC20 -> 1000 srcPref) -> dstHook (1100 dstPref -> 1100 ETH) -> User gets 1 ETH, solver gets 1099 ETH surplus"
        );
        console.log("");
        ...
        int256 contractSrcPrefWithdrawChange =
